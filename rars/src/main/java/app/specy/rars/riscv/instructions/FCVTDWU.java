...
public class FCVTDWU extends BasicInstruction {
    ...
    public void simulate(ProgramStatement statement) throws SimulationException {
        ...
        Float64 converted = app.specy.rars.jsoftfloat.operations.Conversions.convertFromInt(BigInteger.valueOf(RegisterFile.getValue(operands[1]) & 0xFFFFFFFFL),e,tmp);
